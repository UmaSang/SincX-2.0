...
public class TC_SXAdmin_316 extends Baseclass {

    @Test
    public void verifyAddImage() throws InterruptedException, TimeoutException {
        {
            ...
            up.clickToUploadImage();
            up.clickSaveButton();
            up.clickToDeleteUser();
            up.textDeleteField("delete");
            Assert.assertTrue(up.validateUserIsDeleted());
