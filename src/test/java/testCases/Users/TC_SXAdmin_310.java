...
public class TC_SXAdmin_310 extends Baseclass {

    @Test
    public void verifySubTitlesAndCourses() throws InterruptedException, TimeoutException {
        {
            ...
            up.clickCourse();
            Assert.assertTrue(up.validateSubTilesAndCourses());
